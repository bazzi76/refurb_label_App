...
# Eseguire da WSL: bash gateway_test.sh <IP_HOST>
...
PGPASSWORD="$DB_PASS" psql \
    ...
    -U "$DB_USER" \
    -d "$DB_NAME" \
    -c "INSERT INTO device_tests (sn, ext_sn, iccid, esito_test, sgw_type, data)
        VALUES ('${SN}', '${EXT_SN}', '${ICCID}', '${ESITO_TEST}', '${SGW_TYPE}', NOW());"
